...
while(True):
    ...
    if (r >= 0 or middle < -20) and (l != 0):
        if l >= 140:
            s = 'o'
        elif l < 140 and l >= 136 :
            s = 'n'
        elif l < 136 and l >= 132:
            s = 'l'
        elif l < 132 and l >= 128:
            s = 'k'
        elif l < 128 and l >= 120:
            s = 'j'
        elif l < 120 and l >= 100:
            s = 'i'
        elif l < 100 and l > 0:
            s = 'c'
        ...
        if r <= -140 :
            s = '\\'
        elif r > -140 and r <= -136:
            s = ']'
        elif r > -136 and r <= -132:
            s = '^'
        elif r > -132 and r <= -128:
            s = '_'
        elif r > -128 and r <= -120:
            s = '`'
        elif r > -120 and r <= -100:
            s = 'a'
        elif r > -100 and r <= 0:
            s = 'i'
