...
while(True):
    ...
    low_white = np.array([0, 0, 255-70])
    up_white = np.array([180, 0+70, 255])
    ...
    #cv2.imshow('masked_image_stop_line', masked_image_stop_line) 
