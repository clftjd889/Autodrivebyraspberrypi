...
void loop() {
  ...
  if(Serial.available()){
    ...
    if(raspr >= 91 and raspr < 94 and delay_count != 2) {
      delay(1500); 
      delay_count = 2;
    }

    else if(raspr >= 94 and raspr <= 96 and delay_count < 1 and delay_count >= -2) {
      delay(500);
      delay_count = 1;
    }

    else if(raspr >= 100 and raspr <= 105 and delay_count != 0) {
      delay_count = 0;
    }

    else if(raspr <= 111 and raspr > 108 and delay_count != -2) {
      delay(1500);
      delay_count = -2;
    }

    else if(raspr <= 108 and raspr > 106 and delay_count <= 2 and delay_count > -1) {
      delay(500);
      delay_count = -1;
    }
